    ...
    <div className="p-8 bg-white font-sans flex flex-col gap-6">
        {[
            ...
            <div key={label} className="flex items-baseline gap-6">
                <span className="text-xs font-mono text-gray-300 w-20 shrink-0">{label}</span>
...
export const Mono = () => (
    <div className="p-8 bg-white font-sans flex flex-col gap-4">
        <p className="text-xs font-mono text-gray-400 uppercase tracking-widest mb-2">JetBrains Mono · labels, metadata</p>
        {[
            "98% MATCH",
            "30분 · 쉬움 · 4인분",
            "HERO · 최선 조합",
            ...
            <span key={t} className="font-mono text-sm text-gray-600">{t}</span>
        ))}
    </div>
);
...
export const Colors = () => (
    <div className="p-8 bg-white font-sans flex flex-col gap-3">
        <p className="text-xs font-mono text-gray-400 uppercase tracking-widest mb-2">Text Color Scale</p>
